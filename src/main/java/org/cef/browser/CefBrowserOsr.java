...
public class CefBrowserOsr extends CefBrowser_N implements CefRenderHandler {
    ...
    /*
     *  Big thanks to montoyo (https://github.com/montoyo) for figuring this out first.
     *  I take no credit for this. I do want to eventually improve it.
     *
     *  Please check out mcef on GitHub for the original source code.
